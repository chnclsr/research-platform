...
$bundleRoot = Join-Path $accessRoot "research-platform-team-client-v0.5.1"
...
$zipPath = Join-Path $accessRoot "research-platform-team-client-v0.5.1.zip"
